...
def run_script(set_type):
    os.system('ls '+CLASS+'_data/'+set_type+'/ > file_list')
    ...
    for file in file_list:
        data_temp =  pd.read_csv(CLASS+'_data/'+set_type+'/'+file)
    ...
    band_params = [ 'var_index' ,'var_prob' , 'ks_prob' , 'kp_prob' ,'var_sigma' ,'var_mean' , 'var_min' ,  'var_max' , 'var_inter_index' , 'var_inter_prob' , 'var_inter_sigma']
    ...
    single_params = ['photflux_aper' ,'photflux_aper_lolim' , 'photflux_aper_hilim' , 'flux_aper' , 'flux_aper_lolim' , 'flux_aper_hilim' , 'hard_hm' ,  'hard_hs' , 'hard_ms' , 'flux_powlaw'  , 'powlaw_gamma' ,  'powlaw_gamma_rhat' , 'powlaw_nh' , 'powlaw_nh_rhat' , 'powlaw_ampl' , 'powlaw_ampl_rhat' , 'powlaw_stat' , 'flux_bb' , 'flux_bb_hilim' , 'flux_bb_lolim' , 'bb_kt' , 'bb_nh' , 'bb_nh_rhat' , 'bb_ampl' ,  'bb_stat' , 'flux_brems' , 'brems_kt' , 'brems_nh' ,'brems_nh_rhat' ,'brems_stat' , 'flux_apec' ,  'apec_kt' , 'apec_abund' , 'apec_abund_rhat' ,'apec_z' ,  'apec_norm' , 'apec_nh' , 'apec_stat']
    ...
    data_final.to_csv('processed_data/'+CLASS+'_'+set_type+'.csv')
